...
public class BetterSpinner extends android.support.v7.widget.AppCompatAutoCompleteTextView implements AdapterView.OnItemClickListener {
    ...
    public void setCompoundDrawablesWithIntrinsicBounds(Drawable left, Drawable top, Drawable right, Drawable bottom) {
        Drawable dropdownIcon = ContextCompat.getDrawable(getContext(), R.mipmap.arrow_down);
